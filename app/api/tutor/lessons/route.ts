...
import { syncLessonCreate, syncLessonDelete } from '@/lib/googleCalendarSync'
...
export async function DELETE(req: NextRequest) {
  ...
  // Synchronizacja: usuń odpowiadające wydarzenie w Google Calendar. Nigdy nie rzuca.
  await syncLessonDelete(id, tutor.tutorId)
